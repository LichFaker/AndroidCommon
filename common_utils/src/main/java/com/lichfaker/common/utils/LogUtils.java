...
public class LogUtils {
    ...
    private static String LOG_TAG = null; // 默认的tag为null
    ...
    public static void init(Context context, boolean log_switch, boolean log_to_file) { // 在Application中初始化
    ...
    /**
     * 获取默认Tag [ (className.java:100)#MethodName ]
     *
     * @return
     */
    ...
    private static void log(String tag, String msg, Throwable tr, char level) {
        if (LOG_SWITCH) {
            ...
            tag = tag == null ? getDefaultTag() : tag;
