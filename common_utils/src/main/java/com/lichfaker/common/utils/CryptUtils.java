...
import static com.lichfaker.common.utils.ConvertUtils.bytes2HexString;
import static com.lichfaker.common.utils.ConvertUtils.hexString2Bytes;
...
public class CryptUtils {
     ...
     * @throws Exception
     */
    public static String encryptHMAC(String msg, String keyString, String algo) {
        String digest = null;
        try {
    ...
    public static String encryptMD5(String data) {
        return encryptMD5ToString(data.getBytes()).toUpperCase();
    }

    public static String encryptMD5ToLower(String data) {
